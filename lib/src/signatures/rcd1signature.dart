/// RCD1Signature signature implementation
library;
...
final class RCD1Signature extends Signature {
  const RCD1Signature({
  ...
  /// Parse from JSON
  static RCD1Signature? fromJson(Map<String, dynamic> json, [int depth = 0]) {
    try {
