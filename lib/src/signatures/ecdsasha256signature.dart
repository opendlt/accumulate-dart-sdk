/// EcdsaSha256Signature signature implementation
library;
...
final class EcdsaSha256Signature extends Signature {
  const EcdsaSha256Signature({
  ...
  @override
  String get $type => 'EcdsaSha256Signature';
  ...
  /// Parse from JSON
  static EcdsaSha256Signature? fromJson(Map<String, dynamic> json, [int depth = 0]) {
    try {
