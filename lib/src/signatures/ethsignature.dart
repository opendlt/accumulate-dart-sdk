/// ETHSignature signature implementation
library;
...
final class ETHSignature extends Signature {
  const ETHSignature({
  ...
  /// Parse from JSON
  static ETHSignature? fromJson(Map<String, dynamic> json, [int depth = 0]) {
    try {
