// examples\v3\SDK_Examples_file_7_Custom_Tokens_v3.dart
//
// This example demonstrates:
// - Alternative custom token example with different precision
...
Future<void> main() async {
  print("=== SDK Example 7: Custom Tokens (Alt) ===\n");
...
Future<void> testFeatures() async {
  ...
  try {
    ...
    String adiName = "sdk-token7-${DateTime.now().millisecondsSinceEpoch}";
    ...
    print("  Symbol: $symbol");
    print("  Precision: $precision (like cents)\n");
    ...
    String account1Url = "$identityUrl/myCustomTokenAccount1";
    String account2Url = "$identityUrl/myCustomTokenAccount2";
    ...
    int issueAmount = 100000; // 1000.00 MYT2 (2 decimal precision)
    print("Issuing $issueAmount tokens (1000.00 MYT2) to $account1Url");
    ...
    int sendAmount = 6000; // 60.00 MYT2
    print("Sending $sendAmount tokens (60.00 MYT2) from account 1 to account 2");
    ...
    print("Token Account 1: $account1Url");
    print("Token Account 2: $account2Url");
    print("\nOperations:");
    print("  - Issued 1000.00 $symbol to Account 1");
    print("  - Transferred 60.00 $symbol to Account 2");
    print("  - Account 1 balance: 940.00 $symbol");
    print("  - Account 2 balance: 60.00 $symbol");
